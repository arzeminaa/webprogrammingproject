...
window.addEventListener('scroll', function() {
  ...
  // Show the calculator when the user scrolls to it
  if (scrollPosition >= calculatorSection.offsetTop) {
